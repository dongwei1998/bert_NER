...
def train_step(inputs, targets):
    ...
    with tf.GradientTape() as tape:
        predictions = transformer(inputs=inputs,training=True, encode_padding_mask=encode_padding_mask)
...
if __name__ == '__main__':
    ...
    # 数据加载
    train_dataset, args = data_help.data_set_alphamind(args, set_type=True, mode='dev')
